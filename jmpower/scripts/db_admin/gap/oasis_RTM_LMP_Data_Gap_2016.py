...
if __name__ == "__main__":
	...
	sqlcursor.execute("SELECT DISTINCT interval_start FROM lmp_rtm WHERE interval_start >= '2016-01-01'::date AND interval_start < '2017-01-01'::date ORDER BY interval_start;")
	...
	for interval in intervals:
		...
		if firstInterval != interval:
			if lastInterval == date:
				...
				f = open('../../../results/duplicates_2016.txt', 'a')
				line = date.isoformat()  + '\n'
				f.write(line)
				f.close()
